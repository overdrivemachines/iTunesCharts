...
ActiveRecord::Schema.define(version: 20161205164120) do
  ...
  create_table "chart_items", force: :cascade do |t|
    ...
    t.integer  "top5",       limit: 2, default: 0
    t.integer  "top10",      limit: 2, default: 0
    t.integer  "top25",      limit: 2, default: 0
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
